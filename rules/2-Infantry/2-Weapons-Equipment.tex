...
\begin{tabular}{!{\Vline{1pt}} m{6em} !{\Vline{1pt}} R{4.5em} !{\Vline{1pt}} R{3em} !{\Vline{1pt}} R{6.5em} !{\Vline{1pt}} R{6.5em} !{\Vline{1pt}} R{2em} !{\Vline{1pt}}}
\Hline{1pt}
\rowcolor{black!30}  \bfseries{Weapon} & \bfseries{Damage} & \bfseries{Shots} & \bfseries{Short Range} & \bfseries{Long Range} & \bfseries{PV} \\
\Hline{1pt}
SMG           & 3X & x3 &  5 &  17 &  23  \\
Rifle         & 4X & x1 & 26 &  85 & 159  \\
Laser SMG     & 4X & x3 & 43 & 127 &  76  \\
Laser Rifle   & 5X & x1 & 66 & 232 & 143  \\
Gyrojet Rifle & 6X & x1 & 31 & 137 & 107  \\
\Hline{1pt}
\end{tabular}
\caption*{Primary Weapons}
\end{table}

Each weapon can only fire a limited number of shots into a firing arc.
The shots modifier gives the scaling for the number of shots based upon firing arc size.
...
\rowcolor{black!30}  \bfseries{Weapon} & \bfseries{Damage} & \bfseries{Shots} & \bfseries{Short Range} & \bfseries{Long Range} & \bfseries{PV} \\
\Hline{1pt}
Pistol        & 2X & x2 &  7 & 20 & 13  \\
Auto Pistol   & 3X & x3 &  6 & 22 & 19  \\
Laser Pistol  & 4X & x2 & 11 & 40 & 64  \\
\Hline{1pt}
\end{tabular}
...
\centering
\newcolumntype{R}[1]{>{\raggedleft\let\newline\\\arraybackslash\hspace{0pt}}m{#1}}
\begin{tabular}{!{\Vline{1pt}} m{7.2em} !{\Vline{1pt}} R{5.8em} !{\Vline{1pt}} R{4.5em} !{\Vline{1pt}} R{6.5em} !{\Vline{1pt}} R{6.5em} !{\Vline{1pt}} R{2em} !{\Vline{1pt}}}
\Hline{1pt}
\rowcolor{black!30}  \bfseries{Weapon} & \bfseries{Damage} & \bfseries{AP Cost} & \bfseries{Short Range} & \bfseries{Long Range} & \bfseries{PV} \\
\Hline{1pt}
Fists         & (max AP/2)\textbackslash & 5 & 1 & -- & --  \\
Bayonet/Knife & 3X                       & 5 & 1 & -- & --  \\
Blackjack     & 5\textbackslash          & 5 & 1 & -- &  5  \\
Club          & 1X, 4\textbackslash      & 5 & 1 & -- &  2  \\
Stun Baton    & 8\textbackslash          & 5 & 1 & -- &  6  \\
Sword         & 4X                       & 5 & 1 & -- &  6  \\
Vibroblade    & 5X                       & 5 & 1 & -- & 19  \\
\Hline{1pt}
\end{tabular}
...
\centering
\newcolumntype{R}[1]{>{\raggedleft\let\newline\\\arraybackslash\hspace{0pt}}m{#1}}
\begin{tabular}{!{\Vline{1pt}} m{8em} !{\Vline{1pt}} R{4.9em} !{\Vline{1pt}} R{4.1em} !{\Vline{1pt}} R{4em} !{\Vline{1pt}} R{6.5em} !{\Vline{1pt}} R{6.5em} !{\Vline{1pt}} R{2em} !{\Vline{1pt}}}
\Hline{1pt}
\rowcolor{black!30}  \bfseries{Weapon} & \bfseries{Damage} & \bfseries{AP Cost} & \bfseries{Ammo} & \bfseries{Short Range} & \bfseries{Long Range} & \bfseries{PV} \\
\Hline{1pt}
Hand Grenade   &    6X/3X/1X & AP      & 4 & AP   & -- & 44  \\
Satchel Charge &   10X/5X/2X & 3 or AP & 1 & AP/2 & -- & 88  \\
\Hline{1pt}
\end{tabular}

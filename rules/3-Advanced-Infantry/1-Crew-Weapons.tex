...
The crew indicates how many additional troopers must be nearby to setup or break down the weapon.
These additional troopers still use their standard weapons.
For example, a semi-portable laser requires one extra trooper to be adjacent to the trooper carrying the weapon during setup or break down.
Each trooper involved must use 4 AP to setup or break down a crew served weapon.

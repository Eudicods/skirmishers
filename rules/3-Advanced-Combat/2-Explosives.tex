...
\Hline{1pt}
Light Anti-Tank Weapon  &     7X/3X/1X & 4 & 1 & 22 & 80  \\
Rocket Launcher         &     8X/4X/2X & 5 & 2 & 44 & 108 \\
Anti-Tank Missile       & 13X/6X/3X/1X & 5 & 1 & 54 & 96  \\
Grenade Launcher        &     4X/2X/1X & 3 & 4 & 10 & 24  \\
Auto-Grenade Launcher   &     3X/2X/1X & 4 & 4 & 22 & 50  \\
Recoilless Rifle        &     4X/2X/1X & 4 & 2 & 36 & 70  \\
\Hline{1pt}
\end{tabular}
...
\rowcolor{black!30}  \bfseries{Weapon} & \bfseries{Damage} & \bfseries{AP Cost} & \bfseries{Ammo} & \bfseries{Short Range} & \bfseries{Long Range} \\
\Hline{1pt}
Flamethrower       &    2X/1X &  2 & - &  6 &  12  \\
Heavy Flamethrower & 2X/2X/1X &  4 & 4 &  6 &  12  \\
Incendiary Grenade & 4X/2X/1X & AP & 4 & AP &   -  \\
Incendiary Rocket  & 4X/2X/1X &  5 & 2 & 44 & 108  \\
\Hline{1pt}
\end{tabular}
\caption*{Advanced Explosive Weapons}
\end{table}

...
On the given template, the triangle indicates the front of the vehicle and the rear of the vehicle.

The trooper sits on the rear dot of the template, and weapon attacks to or from the trooper are measured from this point.
Front facing weapons are mounted on the front dot and rear facing weapons are mounted on the rear dot.
Weapon attacks on the vehicle may target either dot.
...
For example, if a vehicle has a speed modifier of 3, then the vehicle and trooper together can only be attacked once for each 3 dots traversed.
...
If a trooper fails a control check, has insufficient AP to complete the current movement mode, or the vehicle is damaged and cannot complete the movement mode, then the vehicle and rider wipe out.
...
If the vehicle hits an impassible obstruction or solid obstruction while skidding, then stop the skid immediately and apply ramming damage to the vehicle and trooper.
...
Only apply damage to the vehicle if it has no remaining armor.

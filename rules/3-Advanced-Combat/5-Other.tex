...
Add a +1 modifier to the target number for any attack at long range targeting a trooper wearing a sneak suit.
...
When using breach rules, the toughness of each building and wall must be identified before the game starts.
...
As with buildings, after the tree is destroyed, the terrain becomes rough on that dot and costs 3 AP to move into.
...
Each remaining trooper must roll 2D6 and meet the target number given in the chart below.
Apply a +1 modifier for each additional dead trooper above 4.
For example, add a +2 modifier if 6 troopers in the squad are dead.
